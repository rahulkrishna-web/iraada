  ...
  return (
    <div className='text-[#3c8572]'>
        ...
        <div className='flex flex-col items-center '>
            ...
            <p className='md:max-w-md text-center mx-auto text-[#436f52]'>who want to become their better selves, lead with more clarity, build mental & emotional strength and grow into confident decision makers.
