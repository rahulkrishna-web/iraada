  ...
  return (
    <div className='py-12'>
        ...
        <div className='grid gap-2 grid-cols-3 px-5'>
            ...
            <div className='text-center'>
                <h3 className='text-3xl font-bold text-[#a8ca8f]'><CountUp enableScrollSpy start={0} end={4} />+</h3>
                <h4 className='font-bold text-[#a8ca8f]'>Spots</h4>
                <p>to pause, reflect, play and laugh (at oneself also)</p>
            </div>
            <div className='text-center'>
                <h3 className='text-3xl font-bold text-[#a8ca8f]'>1</h3>
                <h4 className='font-bold text-[#a8ca8f]'>Community</h4>
