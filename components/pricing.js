...
export const Pricing = () => {
  return (
    <div className='py-24 bg-[#F7FAF8] text-[#3c8572]'>
        ...
        Access to all transformative workshops across 3 days is at ₹ 15,999/- towards design of the event, curation of the workshops, hospitality for facilitators and speakers
<br /><br />
