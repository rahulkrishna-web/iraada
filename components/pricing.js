...
export const Pricing = () => {
  return (
    <div className='py-24'>
        ...
        <h2 className='text-3xl font-bold text-center mb-4 font-spectral'>Paisa Kitna Lagenga?</h2>
        <p className='px-5'>
...
Accommodation at the beautiful xxx acres at K property (hyperlink) & Jain food for 2 Nights 3 Days( 7 meals, 3 snack is at 0 INR i.e. Free.
