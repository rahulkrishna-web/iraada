...
export const Faq = () =>{
  return(
    <section id="faq" className="flex flex-col items-center justify-center gap-4 py-24 bg-gradient-to-b from-transparent to-brandGreen">
      <div className="inline-block max-w-lg text-center justify-center px-5">
        <h2 className='text-3xl font-bold text-center mb-12 font-spectral'>FAQ</h2>
        <Accordion>
